	...
	*/
{
	...
	_initProp: function () {
		...
		this.fileServer = gEcnu.config.tileMapUrl + "FileServer?fn=";
		this.dynFileServer = this.serverURL + 'FileServer?fn=';
	},
	/**
	 * 事件监听注册_私有函数
	 * @public
	...
	_createPrintDiv: function (outerDiv,w,h){ 
		...
		infoDiv.innerHTML = '上海市农用地综合管理平台\n\n  '+year+'年'+month+"月"+day+'日'; 
	...
	_reqImageByScale: function (params,img,imgDiv){
		...
		try { 
			gEcnu.Util.ajax("get", mapurl, params, true, function (data) {
                ...
                target_img.src=self.dynFileServer + data.mapURL; 
