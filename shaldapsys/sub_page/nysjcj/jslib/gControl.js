...
gEcnu.Control.Scale = gEcnu.Control.extend({
     ...
     _showScaleText: function(ctx,h){
        ...
        // var multiple=result.m;
         ...
         ctx.fillText(halfkmscale, widthHalf+10, h - 10);
     ...
     renew: function(){
        //this._container.style.width = this._map.w + 'px';
         //this._container.style.height = this._map.h + 'px';
         this.clear();
...
gEcnu.Control.EagleEye = gEcnu.Control.extend({
  ...
  _reqDyn:function (){    //显示当前的所有可见动态图层
    ...
    //var mapurl="http://58.198.182.28:81/WebMap";    
